<!--
  Interactive Grid Pattern background from Inspira UI:
  https://inspira-ui.com/docs/en/components/backgrounds/interactive-grid-pattern
  Colors changed from gray to Nuxt UI's `primary` (green) to match UAuthForm.
-->
...
function getRectClass(index: number) {
  return [
    'stroke-primary/20 transition-all duration-100 ease-in-out not-[&:hover]:duration-1000',
    hoveredSquare.value === index ? 'fill-primary/50' : 'fill-transparent',
